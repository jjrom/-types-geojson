// Type definitions for GeoJSON with additionnal STAC support
// Definitions by : Jérome Gasperi <https://github.com/jjrom>
//
// Based on the Type definitions for non-npm package geojson 7946.0
...
export type GeoJsonSTACLinks = [] | null;

export type GeoJsonSTACAssets = { [name: string]: any; } | null;
